...
public class SwiftFlutterCallkitIncomingPlugin: NSObject, FlutterPlugin, CXProviderDelegate {
  ...
  public func provider(_ provider: CXProvider, didActivate audioSession: AVAudioSession) {
    ...
    configurAudioSession()
    self.sendEvent(
      SwiftFlutterCallkitIncomingPlugin.ACTION_CALL_TOGGLE_AUDIO_SESSION, ["isActivate": true])
  }
  ...
  public func provider(_ provider: CXProvider, didDeactivate audioSession: AVAudioSession) {
    ...
    self.callManager.removeAllCalls()
    self.sendEvent(
      SwiftFlutterCallkitIncomingPlugin.ACTION_CALL_TOGGLE_AUDIO_SESSION, ["isActivate": false])
  }
